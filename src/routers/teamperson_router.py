...
from src.services.teamperson_service import create_teamperson_service, read_teamperson_service, read_all_teampersons_service
...
router = create_crud_router(
    ...
    read_all_service=read_all_teampersons_service,
