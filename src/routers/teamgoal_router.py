...
from src.services.teamgoal_service import create_teamgoal_service, read_teamgoal_service, read_all_teamgoals_service
...
router = create_crud_router(
    ...
    read_all_service=read_all_teamgoals_service,
